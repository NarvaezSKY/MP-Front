      ...
      <div className="model-info">
        <section>
          ...
          <p>
            ...
            probabilidad de <strong>demanda</strong> (la ficha se ejecuta/termina) frente al{' '}
        ...
        <section>
          ...
          <p>
            Se usan variables históricas del programa <em>sin fuga de futuro</em> (número de ofertas
            anteriores, tasa de demanda previa, promedio de matriculados, recencia y tendencia). El
